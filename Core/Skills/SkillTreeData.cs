...
namespace SkillTree.Core.Skills
{
    public class SkillTreeData
    {
        ...
        public static Skill MoreMovespeed = new("Fleet Feet", "Increase movement speed by 15% per level", SkillCategory.Stats, 2, Stats, [Patches.Stats.MovementPatches.SetPlayerSpeed]);
        public static Skill SpringHeeled = new("Spring-Heeled", "Increase max stamina by 30% and jump height by 35%", SkillCategory.Stats, 1, MoreMovespeed, [Patches.Stats.MovementPatches.SetPlayerJumpHeight, Patches.Stats.MovementPatches.SetPlayerStamina]);
        public static Skill MoreStackItem = new("Prison Wallet", "Increase item stack size by 100% per level", SkillCategory.Stats, 3, Stats, [Patches.Stats.MoreStackItem.SetItemStackSize]);
        public static Skill AllowSeeCounteroffChance = new("Crystal Ball", "See the chance of a customer accepting a counteroffer", SkillCategory.Stats, 1, Stats);
        ...
        public static Skill MoreXP = new("Fast Learner", "Increase XP gain by 5%", SkillCategory.Stats, 2, Stats);
        public static Skill MoreXP2 = new("Turbo Nerdo", "Increase XP gain by an additional 10%", SkillCategory.Stats, 2, MoreXP);
        public static Skill MoreXPWhenEarnMoney = new("Kingpin", "Gain 5% of a drug sale's value as bonus XP", SkillCategory.Stats, 1, MoreXP);

        public static Skill Operations = new("Pitchin' a Tent", "Increase quality of plants in grow tents by 16%", SkillCategory.Operations, 1, null);
        ...
        public static Skill MoreQualityMethCoca = new("Harder and Stronger", "Meth and cocaine quality increased by 1", SkillCategory.Operations, 1, MoreQuality);
        public static Skill Mushroomancer = new("Mushroomancer", "Increase mushroom quality by 15%", SkillCategory.Operations, 2, MoreQuality);
        public static Skill WetAssPlants = new("Wet-Ass Plants", "Moisture drains 50% slower for all grow containers", SkillCategory.Operations, 1, Operations);
        public static Skill AbsorbentSoil = new("Absorbent Soil", "Soil additives last until the soil is depleted", SkillCategory.Operations, 1, WetAssPlants);
        public static Skill GrowthSpeed = new("Green Thumb", "Increase plant and mushroom growth speed 2.5%", SkillCategory.Operations, 2, Operations);
        public static Skill GrowthSpeed2 = new("Plant Whisperer", "Increase plant and mushroom growth speed by an additional 2.5%", SkillCategory.Operations, 2, GrowthSpeed);
        public static Skill ChemistStationQuick = new("Quick Crafter", "Double the speed of cauldrons, chemistry stations, lab ovens, and mixing stations", SkillCategory.Operations, 1, GrowthSpeed);
        public static Skill MoreYield = new("Bountiful Harvest", "Increase base yield of plants by 1", SkillCategory.Operations, 1, Operations);
        public static Skill MoreMixAndDryingRackOutput = new("Crankin' One Out", "Double the production capacity of mixing stations and drying racks", SkillCategory.Operations, 1, MoreYield);
        public static Skill MoreCauldronOutput = new("Witch's Brew", "Double the cauldron's output", SkillCategory.Operations, 1, MoreYield);

        public static Skill Social = new("Silver Tongued Devil", "Increase chance a potential customer will accept a free sample by 5%", SkillCategory.Social, 1, null);
        ...
        public static Skill CityEvolving = new("Spread the Wealth", "Increase citizens' weekly spending limits by 10% per level", SkillCategory.Social, 2, Social, [Patches.Social.CustomerPatches.SetCustomerSpendLimits]);
        public static Skill MoreATMLimit = new("Hoard the Wealth", "Increase ATM deposit limit by $2000 per level", SkillCategory.Social, 2, Social);
        public static Skill BusinessEvolving = new("Squeaky Clean", "Increase money laundering capacity by 30%", SkillCategory.Social, 2, MoreATMLimit, [Patches.Social.BusinessPatches.SetLaunderingCapacity]);
        public static Skill Informant = new("Informant", "Police are shown on the map", SkillCategory.Social, 1, Social, [Patches.Special.NPCPatches.UpdateVisibility]); 
        public static Skill Spymaster = new("Spymaster", "Benzies are shown on the map", SkillCategory.Social, 1, Informant, [Patches.Special.NPCPatches.UpdateVisibility]); 
        public static Skill BetterSupplier = new("Reliable Business Partner", "Increase dead drop order limit by 67.5% and item limit by 50%", SkillCategory.Social, 2, Social);
        ...
        public static Skill DealerMoreCustomer = new("Expansive Empire", "Increase dealer's customer limit by 2", SkillCategory.Social, 1, Social);
        public static Skill DealerCutLess = new("Wage Garnishment", "Decrease dealer's cut by 5%", SkillCategory.Social, 2, DealerMoreCustomer, [Patches.Social.DealerPatches.SetDealerCut]);
        public static Skill DealerSpeedUp = new("Motivational Leader", "Double the movespeed of dealers", SkillCategory.Social, 1, DealerMoreCustomer, [Patches.Social.DealerPatches.SetDealerMoveSpeed]);
        ...
        public static Skill EmployeeMaxStation = new("Overworked and Underpaid", "Increase station assignment limit for botanists and chemists by 2", SkillCategory.Special, 2, BetterBotanists);
