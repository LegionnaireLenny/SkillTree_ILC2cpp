...
namespace SkillTree.Core.Utilities
{
    public class ConfigManager
    {
        ...
        public static void Initialize()
        {
            ...
            BaseHealth = new ConfigEntry<float>(BaseGameSettings, "SkillTree_BaseMaxHealth", PlayerHealth.MAX_HEALTH, "Base Maximum Health");
            BaseHealthRegen = new ConfigEntry<float>(BaseGameSettings, "SkillTree_BaseHealthRegen", 0.5f, "Base Health Restored Per Second");
            BaseHealthRegenDelay = new ConfigEntry<float>(BaseGameSettings, "SkillTree_BaseHealthRegenDelay", 30f, "Base Time Until Health Regenerates");
            BaseStamina = new ConfigEntry<float>(BaseGameSettings, "SkillTree_BaseStamina", PlayerMovement.StaminaReserveMax, "Base Maximum Stamina");
            BaseJumpHeight = new ConfigEntry<float>(BaseGameSettings, "SkillTree_BaseJumpHeight", PlayerMovement.JumpMultiplier, "Base Jump Height");
            BaseArrestTime = new ConfigEntry<float>(BaseGameSettings, "SkillTree_BaseArrestTime", 1.75f, "Base Arrest Time");
            BaseArrestRadius = new ConfigEntry<float>(BaseGameSettings, "SkillTree_BaseArrestRadius", 2.75f, "Base Arrest Radius");
            BaseDryingRackCapacity = new ConfigEntry<int>(BaseGameSettings, "SkillTree_BaseDryingRackCapacity", 20, "Base Drying Rack Capacity");
            BaseCauldronOutput = new ConfigEntry<int>(BaseGameSettings, "SkillTree_BaseCauldronOutput", 10, "Base Cauldron Output");
            BaseWeeklyDepositLimit = new ConfigEntry<float>(BaseGameSettings, "SkillTree_BaseWeeklyDepositLimit", ATM.WEEKLY_DEPOSIT_LIMIT, "Base Weekly ATM Deposit Limit");
            BaseTrashGrabberBinSize = new ConfigEntry<int>(BaseGameSettings, "SkillTree_BaseTrashGrabberBinSize", 20, "Base Trash Grabber Bin Size");
            BaseDeadDropItemLimit = new ConfigEntry<int>(BaseGameSettings, "SkillTree_BaseDeadDropItemLimit", Supplier.DEADDROP_ITEM_LIMIT, "Base Deaddrop Item Limit");
            BaseMaxCustomer = new ConfigEntry<int>(BaseGameSettings, "SkillTree_BaseMaxCustomer", Dealer.MAX_CUSTOMERS, "Base Max Customers for Dealers");
            BaseMaxChemistStations = new ConfigEntry<int>(BaseGameSettings, "SkillTree_BaseMaxChemistStations", 4, "Base Maximum Chemist Stations");
            BaseMaxBotanistStations = new ConfigEntry<int>(BaseGameSettings, "SkillTree_BaseMaxBotanistStations", 8, "Base Maximum Botanist Stations");
