...
namespace SkillTree.Core.FileManagement
{
    ...
    public class SkillTreeData
    {
        ...
        [Skill("Chemist Station Quick", "Increase the speed of ALL Chemistry Station (x2 or a little more)", SkillCategory.Operations, "GrowthSpeed", 1)]
        ...
        [Skill("More Mix and Drying Rack Output", "Double Mix and Drying Rack Output", SkillCategory.Operations, "MoreYield", 1)]
        public int MoreMixAndDryingRackOutput = 0;

        [Skill("More Cauldron Output", "Double Cauldron Output", SkillCategory.Operations, "MoreYield", 1)]
