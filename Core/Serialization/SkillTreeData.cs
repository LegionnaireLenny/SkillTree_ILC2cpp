...
namespace SkillTree.Core.Serialization
{
    public class SkillTreeData
    {
        ...
        public static readonly Skill PileTheBodiesHigh = new("Pile the Bodies High", "You're a fearsome combatant and the police grow increasingly hesitant in pursuing you for fear of adding to your extensive body count.\n\nPolice search duration is capped at 35 seconds.\n\nIf Blood Rush is unlocked, each officer you've killed further reduces the search timer by 0.1 seconds for a maximum reduction of 10 seconds.", SkillCategory.Enforcer, 1, BattleScarred);
        public static readonly Skill QuickDraw = new("Quick Draw McGraw", "You're the fastest gunslinger in the West(ville).\n\nAim time for ranged weapons is reduced by 50%.", SkillCategory.Enforcer, 1, Hardy, [RangedWeaponPatches.SetWeaponStats]);
        public static readonly Skill Sharpshooter = new("Sharpshooter", "You could shoot a fly off a horse's ass at a hundred paces.\n\nReduces the minimum and maximum spread of ranged weapons by 65%.", SkillCategory.Enforcer, 1, QuickDraw, [RangedWeaponPatches.SetWeaponStats]);
        ...
        public static readonly Skill CombatExperience = new("Combat Experience", "Killing the following NPCs grants XP\n- Police Officer: +12 XP\n- Cartel Goon: +20 XP\n- Cartel Dealer: +30 XP", SkillCategory.Enforcer, 1, Hardy);
        public static readonly Skill SchoolOfHardKnocks = new("School of Hard Knocks", "Increase XP gain by 12.5%.", SkillCategory.Enforcer, 1, CombatExperience);
        ...
        public static readonly Skill HarderAndStronger = new("Harder and Stronger", "Increase meth and cocaine quality by 1.", SkillCategory.Provisioner, 1, AdvancedPotTechniques);
        ...
        public static readonly Skill Apprenticeship = new("Apprenticeship", "- Planting seeds/spores grants 2 XP\n- Harvesting plants grants an additional 200% XP\n- Harvesting mushrooms grants the same XP as plants\n- Producing drugs and precursors grants 5 XP\n- Packaging drugs grants 1 XP per product\n- Mixing grants 1 XP per product\n- Creating new mixes grants an additional 25% XP.", SkillCategory.Provisioner, 1, PitchinATent);
        public static readonly Skill Meister = new("Meister", "Increase XP gain by 12.5%.", SkillCategory.Provisioner, 1, Apprenticeship);
        ...
        public static readonly Skill Grifter = new("Grifter", "- Gain 200% more XP from successful counteroffers\n- Gain 10% of a drug sale's value as bonus XP.", SkillCategory.Hustler, 1, SilverTonguedDevil);
        public static readonly Skill MultiLevelMarketeer = new("Multi-level Marketeer", "Increase XP gain by 12.5%.", SkillCategory.Hustler, 1, Grifter);
        ...
        public static readonly Skill MotivationalLeader = new("Motivational Leader", "Increase the movement speed of dealers by 100%.", SkillCategory.Logistician, 1, ExpansiveEmpire, [DealerPatches.SetDealerMoveSpeed]);
        ...
        public static readonly Skill GoodSamaritan = new("Good Samaritan", "Once per day, destroy all trash on the map and gain 100% of the sell value as online balance.\n\nDefault keybind is F1.", SkillCategory.Special, 1, null);
        public static readonly Skill BloodRush = new("Blood Rush", "Active ability: Once per day, fully restore health and gain Blood Rush for 60 seconds.\n\nPassive ability: Gain 0.1 max health for every police officer or cartel member killed, up to 30 health.\n\nWhile Blood Rush is active, the passive health cap is doubled to 60 health and health regen delay is reduced by 80% (90% with Battle-Scarred).\n\nDefault keybind is F2.", SkillCategory.Special, 1, GoodSamaritan);
        public static readonly Skill BloodMoney = new("Blood Money", "Once per day, for 30 seconds your health cannot drop below 1 and you gain 100% of all damage received and dealt as cash.\n\nDefault keybind is F3.", SkillCategory.Special, 1, BloodRush);
        public static readonly Skill SiphonFunds = new("Siphon Funds", "Once per day, instantly collect your money from all dealers. 10% + 5% per owned business of collected money is converted to online balance.\n\nDefault keybind is F4.", SkillCategory.Special, 1, GoodSamaritan);
        public static readonly Skill TrickleDown = new("Trickle-down Economics", "Once per day, instantly deposit your cash in all owned businesses for laundering while keeping a minimum in reserve.\n\nLaundering operations now pay out in increments of 25% every 6 hours instead of 100% every 24 hours.\n\nDefault keybind is F5.", SkillCategory.Special, 1, GoodSamaritan);
        public static readonly Skill InfectiousPersonality = new("Infectious Personality", "Once per day, all NPCs within 15 meters are randomly afflicted with Toxic or Explosive.\n\nCharacters afflicted with Toxic die after 8 seconds, characters afflicted with Explosive explode and die after 30 seconds.\n\nUpon death, the effect is spread to nearby characters and half of their health is gained as cash and online balance.\n\nDefault keybind is F6.", SkillCategory.Special, 1, GoodSamaritan);
        public static readonly Skill AdrenalineSurge = new("Adrenaline Surge", "Three times per day, your movement speed and jump height are tripled for 15 seconds.\n\nDefault keybind is F7.", SkillCategory.Special, 1, GoodSamaritan);
        public static readonly Skill AntiGravityBong = new("Anti-Gravity Bong", "Once every 60 seconds, place a special anti-gravity bong that ragdolls and flings away any NPC within a 10 meter radius.\n\nLasts for 15 seconds. When the skill expires, the bong pulls NPCs towards itself and explodes.\n\nDefault keybind is F8.", SkillCategory.Special, 1, GoodSamaritan);
