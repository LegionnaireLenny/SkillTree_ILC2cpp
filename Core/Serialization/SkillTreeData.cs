...
namespace SkillTree.Core.Serialization
{
    public class SkillTreeData
    {
        ...
        public static readonly Skill MoreStackItem = new("Prison Wallet", "Increase item stack size by 100% per level", SkillCategory.Enforcer, 3, Enforcer, [Patches.Enforcer.MoreStackItem.SetItemStackSize]);
